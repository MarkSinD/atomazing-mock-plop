	...
	plop.setGenerator('init mock packages', {
		...
		actions: [
			...
			},
			{
				type: 'add',
				skipIfExists: true,
				path: 'mocks/handlers/handlers.ts',
		...
		actions: [
			{
				type: 'add',
				skipIfExists: true,
				path: 'store/api/{{camelCase name}}/{{camelCase name}}Api.ts',
				templateFile: 'src/templates/api/api.ts',
			},
			{
				type: 'add',
				skipIfExists: true,
				path: 'store/api/{{camelCase name}}/index.ts',
				templateFile: 'src/templates/api/index.ts',
			},
			{
				type: 'add',
				skipIfExists: true,
				path: 'models/{{properCase name}}.ts',
			...
			},
			{
				type: 'add',
				skipIfExists: true,
				path: 'mocks/handlers/mock{{properCase name}}/index.ts',
				templateFile: 'src/templates/mocks/index.ts',
			},
			{
				type: 'add',
				skipIfExists: true,
				path: 'mocks/handlers/mock{{properCase name}}/mock.ts',
				templateFile: 'src/templates/mocks/mock.ts',
			},
			{
				type: 'add',
				skipIfExists: true,
				path: 'mocks/handlers/mock{{properCase name}}/mockData.ts',
